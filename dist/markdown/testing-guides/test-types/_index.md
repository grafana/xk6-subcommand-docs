...
> **Note:** In k6 scripts, configure the load configuration using [`options`](https://grafana.com/docs/k6/v1.5.0/get-started/running-k6#using-options) or `scenarios`. This separates workload configuration from iteration logic.
...
For example, k6 can model load by either number of VUs or by number of iterations per second (open vs. closed).

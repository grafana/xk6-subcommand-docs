...
k6 offers two ways to increase the activity: increasing VUs or increasing throughput (open and closed models).
...
That makes it recommendable to use ramping-arrival-rate for a breakpoint test.
...
For details, refer to Thresholds.

...
xk6-disruptor is a [k6 extension](https://grafana.com/docs/k6/v1.5.0/extensions). You have to run a k6 version built with the disruptor extension to use the disruptor APIs in your k6 tests.
...
To learn more about xk6, refer to [Build a k6 binary using Go](https://grafana.com/docs/k6/v1.5.0/extensions/build-k6-binary-using-go).

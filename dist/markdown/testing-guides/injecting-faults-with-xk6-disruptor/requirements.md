...
Refer to the Installation section for instructions on how to get this custom build.
...
Refer to Expose your application section for instructions on how to make your application available from outside the Kubernetes cluster.

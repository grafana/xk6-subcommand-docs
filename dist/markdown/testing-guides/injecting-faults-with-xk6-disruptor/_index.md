...
It provides a Javascript API to inject different faults in HTTP and gRPC requests, such as errors and delays, into the selected Kubernetes Pods or Services.
...
Check the first steps to get started with the disruptor.

Follow the examples of injecting faults in different scenarios.

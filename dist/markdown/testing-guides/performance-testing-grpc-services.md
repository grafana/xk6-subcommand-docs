...
- [Install k6 v0.29](https://grafana.com/docs/k6/v1.5.0/set-up/install-k6/) or higher.
...
> **Note:** The QuickPizza gRPC service URL grpc-quickpizza.grafana.com:443 returns a 464 HTTP status code if you try to access it in your browser. However, you can still use it in your k6 test scripts, and the gRPC functionality works correctly.

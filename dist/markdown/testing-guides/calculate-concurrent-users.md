...
> **Note:** You can use any analytics tool that provides the same metrics to help you calculate the concurrent users you need for load testing.
...
> **Note:** These instructions might vary depending on which version of Google Analytics you're using. If you're using Google Analytics 4, you can find these metrics by selecting **Explore** and creating a **Free form** report.
...
These practices help ensure your system remains stable during unexpected traffic increases. Refer to Testing guides for more details about all of the different performance testing strategies.

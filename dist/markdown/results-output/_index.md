...
k6 emits metrics with timestamps at every point of the test.
...
- [Build an output extension](https://grafana.com/docs/k6/v1.5.0/extensions/create/output-extensions)

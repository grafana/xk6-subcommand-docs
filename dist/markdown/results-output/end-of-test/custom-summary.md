...
> **Note:** However, we plan to support the feature for k6 Cloud tests, too.
...
> **Note:** The last examples use imported helper functions.
...
> **Caution:** k6 v1.5.0 introduced a new format available for the end-of-test aggregated statistics object, designed for easier integration
...
The specific values depend on the metric type:
...
> **Note:** If you change the default trend metrics with the `summaryTrendStats` option,

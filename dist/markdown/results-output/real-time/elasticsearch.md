...
> **Caution:** Security and self-signed certificates for non-cloud clusters are not yet supported.

You can now connect to Elasticsearch and query the k6 metrics stored in the `k6-metrics` index.

...
SharedArray was added. It does have some CPU overhead in accessing elements compared to a normal non shared
...
enough and you are not using SharedArray, that might mean that your script will run out of memory at
...
> **Note:** `scenario.iterationInTest` property is unique _per scenario_, not the overall test. That means if you have multiple scenarios in your test you might need to split your data per scenario.

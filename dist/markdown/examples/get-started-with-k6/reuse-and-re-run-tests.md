...
With modules, you can use logic and variables from other files.
...
read the Automated performance testing guide.
...
Or, you can read and explore the testing guides and try to build out your testing strategy.

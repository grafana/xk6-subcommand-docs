...
- [ ][k6 installed](https://grafana.com/docs/k6/v1.5.0/set-up/install-k6)
...
| ---------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| Test for functional behavior | Use k6 to script requests and evaluate that performance is correct |
| Test for performance                 | Use k6 to increase load and find faults                            |
| Analyze results                           | Filter results and make custom metrics                             |
| Reuse and re-run                   | Modularize and re-run tests                                        |

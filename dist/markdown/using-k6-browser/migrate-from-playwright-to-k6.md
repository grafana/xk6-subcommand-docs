...
- A machine with [k6 installed](https://grafana.com/docs/k6/v1.5.0/set-up/install-k6/).
...
> **Note:** There are plans to create a testing framework in k6. For more details or to contribute, refer to this [GitHub issue](https://github.com/grafana/k6-jslib-testing/issues/30).

...
> **Note:** Keep in mind that there is an additional performance overhead when it comes to spinning up a browser VU and that the resource usage will depend on the system under test.

## Browser and HTTP test

To run a browser-level and protocol-level test concurrently in k6, you can use scenarios.

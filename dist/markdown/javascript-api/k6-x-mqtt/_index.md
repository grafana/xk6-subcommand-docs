...
> **Note:** This module is implemented as an official extension and is not part of k6 by default. However, k6's [automatic extension resolution](/docs/k6/v1.5.0/extensions/run) makes it available seamlessly when you import it in your script. Refer to the [extensions documentation](/docs/k6/v1.5.0/extensions/explore) for available extensions and details.
...
- SSL/TLS support using standard k6 TLS configuration
...
| ---------- | ----------- |
| Client | MQTT client for connecting to brokers and managing operations |
| Client.connect() | Connect to an MQTT broker |
| Client.reconnect() | Reconnect to the broker |
| Client.subscribe() | Subscribe to MQTT topics |
| Client.subscribeAsync() | Subscribe to topics asynchronously |
| Client.unsubscribe() | Unsubscribe from topics |
| Client.unsubscribeAsync() | Unsubscribe from topics asynchronously |
| Client.publish() | Publish messages to MQTT topics |
| Client.publishAsync() | Publish messages asynchronously |
| Client.on() | Register event handlers |
| Client.end() | Disconnect from the MQTT broker |
| Client.endAsync() | Disconnect asynchronously |
| QoS | Quality of Service enumeration |

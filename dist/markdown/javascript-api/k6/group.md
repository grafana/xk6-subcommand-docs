...
> **Note:** For details about using the `check()` function with async values, refer to the jslib utils check.
...
> **Warning:** Avoid using `group` with async functions or asynchronous code.

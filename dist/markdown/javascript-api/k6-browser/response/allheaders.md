...
> **Caution:** This method has a **known issue**. For details, refer to [#965](https://github.com/grafana/xk6-browser/issues/965).
...
| Type                              | Description                                                              |
| --------------------------------- | ------------------------------------------------------------------------ |
| `Promise>` | A promise that resolves to an object of key value pairs for each header. |

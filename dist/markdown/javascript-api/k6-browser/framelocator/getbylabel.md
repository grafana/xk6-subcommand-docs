...
| Type                                                                                   | Description                                                                                              |
| -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| Locator | A locator object that can be used to interact with the form control associated with the specified label. |
...
- frameLocator.getByText() - Locate by text content

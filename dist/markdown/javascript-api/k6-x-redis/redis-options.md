...
You can configure the Redis Client by using a Redis connection URL as demonstrated in the client documentation, or by using an [Options](#options) object to access more advanced configuration.

...
The `check` function is a drop-in replacement for the built-in check, with added support for async values. Any `Promise`s will be awaited, and the result is reported once the operation has been completed.

...
Object is returned by the S3Client.\* methods that query S3 buckets' objects. Namely, `listObjects`, `getObject`, `putObject`,
and `deleteObject`. The Object construct describes an Amazon S3 object.

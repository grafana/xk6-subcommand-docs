...
S3MultipartUpload is returned by the `createMultipartUpload(bucketName, objectKey)` method when creating a [multipart upload](https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateMultipartUpload.html).

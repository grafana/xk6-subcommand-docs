...
- A machine with [k6 installed](https://grafana.com/docs/k6/v1.5.0/get-started/installation/).
- A test file.
...
> **Note:** The `k6 cloud run --local-execution` command uploads the test archive k6 produces from your test script and resources to Grafana Cloud.
...
To set up and run a test using the k6 Operator, refer to [Set up distributed k6](https://grafana.com/docs/k6/v1.5.0/set-up/set-up-distributed-k6/).

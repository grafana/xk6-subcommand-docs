...
- [k6 v0.57 or higher](https://grafana.com/docs/k6/v1.5.0/set-up/install-k6/) installed on your machine.
...
> **Note:** To run your test in a specific Grafana Cloud k6 project, you need a Grafana Cloud account with access to that project.

...
> **Note:** HAR is a file format used by all major browsers and various other tools to export recorded HTTP requests.
...
To learn more about how to configure the load options, read the [Adding more VUs guide](https://grafana.com/docs/k6/v1.5.0/get-started/running-k6#adding-more-vus) and the Options guide.
...
Now, you can run your load test with k6. If you have not installed k6 yet, please, follow the [k6 installation instructions](https://grafana.com/docs/k6/v1.5.0/set-up/installation).
...
To learn about running k6, check out the [Running k6 tutorial](https://grafana.com/docs/k6/v1.5.0/get-started/running-k6).

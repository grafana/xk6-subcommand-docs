...
- [Grafana k6 Studio](https://grafana.com/docs/k6/v1.5.0/k6-studio) is an open-source desktop application designed to help you record browser interactions and generate k6 test scripts.

- HAR converter generates a k6 script from the requests included in a HAR file.
...
4. Handle correlation and dynamic data.
...
- Take note of pages where forms/logins occur. You will need to edit the script to handle correlation.
...
An alternative approach to load test websites is to run a hybrid load test which:

- Runs a browser test to validate the frontend.
...
To learn more about this approach, check out the example mixing browser-level and protocol-level tests.

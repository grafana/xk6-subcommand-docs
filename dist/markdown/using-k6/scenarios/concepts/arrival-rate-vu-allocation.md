...
> **Caution:** In cloud tests, **`preAllocatedVUs` count against your subscription.**
...
As open-model scenarios, arrival-rate executors start iterations according to a configured rate.
...
> **Caution:** In cloud tests, the number of `maxVUs` counts against your subscription,

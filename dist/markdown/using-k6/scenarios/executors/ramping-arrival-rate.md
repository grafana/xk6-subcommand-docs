...
Unlike the ramping VUs executor, which configures VUs,
...
To learn how allocation works, read Arrival-rate VU allocation.
...
Besides the common configuration options,

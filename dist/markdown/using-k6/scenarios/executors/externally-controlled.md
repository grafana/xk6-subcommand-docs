...
Control and scale execution at runtime via [k6's REST API](https://grafana.com/docs/k6/v1.5.0/misc/k6-rest-api) or
...
Besides that, this executor has all the common configuration options,

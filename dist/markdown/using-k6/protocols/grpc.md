...
The handler receives an error object.
...
The Client.healthCheck() method implements this protocol and returns the health status of the specified service. If no service name is provided, it checks the overall server health.

...
If the server reports to k6 that it supports HTTP/2, k6 upgrades the connection to HTTP/2 instead.
...
Refer to the [full list of extensions](https://grafana.com/docs/k6/v1.5.0/extensions/explore) and find the ones you want to build. Then follow the [xk6 guide](https://grafana.com/docs/k6/v1.5.0/extensions/build-k6-binary-using-go).

You can build your own extension, too.
See the [tutorials](https://grafana.com/docs/k6/v1.5.0/extensions/create) to get started.

...
The k6/execution module exposes details about the current execution state, such as _the name of the currently executed scenario_, _how many VUs are currently active_, and more.
...
> **Note:** k6 v0.34.0 introduced the **k6/execution** module. If you are using a version of k6 that doesn't have this module, use `__VU` and `__ITER`.

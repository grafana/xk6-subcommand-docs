...
Like the k6 APIs, you can build custom modules in Go code and expose them as JavaScript modules. These custom Go-to-JS modules are known as [k6 extensions](https://grafana.com/docs/k6/v1.5.0/extensions).
...
To learn more about using or creating k6 extensions, refer to the [Extension documentation](https://grafana.com/docs/k6/v1.5.0/extensions).
...
> **Note:** The following options for distributing and sharing JavaScript libraries are available for both custom and other public libraries.
...
> **Caution:** k6 isn't Node.js or a browser. Packages that rely on APIs provided by Node.js, for instance the `os` and `fs` modules, won't work in k6. The same goes for browser-specific APIs, such as the `window` object.
...
k6 supports partial TypeScript support. For more details, refer to JavaScript and TypeScript compatibility mode.
...
To run k6 with extensions in Docker, create a Docker image that includes the k6 binary with any extension you may want to use. Define a `Dockerfile` with the necessary [xk6 build](https://grafana.com/docs/k6/v1.5.0/extensions/build-k6-binary-using-go#breaking-down-the-xk6-command) instructions as follows:
...
After building your custom k6 Docker image, you can [run k6 with Docker](https://grafana.com/docs/k6/v1.5.0/get-started/running-k6/) as usual.
...
- [Extensions directory](https://grafana.com/docs/k6/v1.5.0/extensions/explore): A collection of k6 extensions maintained by Grafana Labs and the community.
